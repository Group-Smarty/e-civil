...
class CreateCertificatNonInscritptionRegistresTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('certificat_non_inscritption_registres', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('certificat_non_inscritption_registres');
    }
}
