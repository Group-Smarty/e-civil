...
function NumberToLetter($number,$separateur=","){
    ...
    elseif ($number < 100) {
      ...
      elseif ($number == 82) {
          return 'quatre vingt deux';
      }
      elseif ($number == 83) {
          return 'quatre vingt trois';
      }
      elseif ($number == 84) {
          return 'quatre vingt quatre';
      }
      elseif ($number == 85) {
          return 'quatre vingt cinq';
      }
      elseif ($number == 86) {
          return 'quatre vingt six';
      }
      elseif ($number == 87) {
          return 'quatre vingt sept';
      }
      elseif ($number == 88) {
          return 'quatre vingt huit';
      }
      elseif ($number == 89) {
          return 'quatre vingt neuf';
      }
      elseif ($number < 70) {
