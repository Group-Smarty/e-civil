...
class RegistredUserNotification extends Notification
{
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
                    ->success()
                    ->subject('Cration de votre compte E-Civil.')
                    ->from('tranxpert@smartyacademy.com', 'E-Civil')
                    ->line("Votre compte E-Civil a bien été crée mais il doit être confirmé. Merci de cliquer sur le bouton suivant.")
