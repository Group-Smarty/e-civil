...
<div class="row">
    <div class="col-lg-4 col-md-4 col-sm-4">
        <form id="formAjout" ng-controller="formAjoutCtrl" action="#">
            <input type="text" id="idCaisseModifier" ng-model="caisse.id" ng-hide="true" class="hide">
            @csrf
            <div class="box box-warning">
                ...
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <input type="text" onkeyup="this.value = this.value.charAt(0).toUpperCase() + this.value.substr(1);" id="libelle_caisse" name="libelle_caisse" ng-model="caisse.libelle_caisse" class="form-control" placeholder="Libellé caisse" required>
                    </div>
                </div>
                <!-- /.box-body -->
    ...
    <div class="col-lg-8 col-md-8 col-sm-8">
        <table id="table" class="table table-warning table-striped box box-warning"
               ...
               data-search="false"
               data-toggle="table"
               data-url="{{url('taxe',['action'=>'liste-caisses'])}}"
               data-unique-id="id"
               data-show-toggle="false">
            <thead>
                <tr>
                    <th data-field="libelle_caisse" data-searchable="true" data-sortable="true">Libell&eacute;  </th>
        ...
        <form id="formSupprimer" ng-controller="formSupprimerCtrl" action="#">
            <div class="modal-content">
                ...
                <div class="modal-body ">
                    ...
                    <div class="clearfix">
                        <div class="text-center question"><i class="fa fa-question-circle fa-2x"></i> Etes vous certains de vouloir supprimer la caisse <br/><b>@{{caisse.libelle_caisse}}</b></div>
    ...
    $(function () {
      ...
      $("#formAjout").submit(function (e) {
            ...
            var $ajaxLoader = $("#formAjout .loader-overlay");
             ...
             if (ajout==true) {
                var methode = 'POST';
                var url = "{{route('taxe.caisses.store')}}";
             }else{
                var id = $("#idCaisseModifier").val();
                var methode = 'PUT';
                var url = 'caisses/' + id;
             }
