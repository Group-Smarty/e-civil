...
<div class="row">
    <div class="col-lg-4 col-md-4 col-sm-4">
        <form id="formAjout" ng-controller="formAjoutCtrl" action="#">
            <input type="text" id="idLocaliteModifier" ng-model="localite.id" ng-hide="true" class="hide">
            @csrf
            <div class="box box-warning">
                ...
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <input type="text" onkeyup="this.value = this.value.charAt(0).toUpperCase() + this.value.substr(1);" id="libelle_localite" name="libelle_localite" ng-model="localite.libelle_localite" class="form-control" placeholder="Libellé de la localité" required>
                    </div>
                </div>
                <!-- /.box-body -->
    ...
    <div class="col-lg-8 col-md-8 col-sm-8">
        <table id="table" class="table table-warning table-striped box box-warning"
               ...
               data-search="false"
               data-toggle="table"
               data-url="{{url('taxe',['action'=>'liste-localites'])}}"
               data-unique-id="id"
               data-show-toggle="false">
            <thead>
                <tr>
                    <th data-field="libelle_localite" data-searchable="true" data-sortable="true">Libell&eacute;  </th>
    ...
    $(function () {
      ...
      $("#formAjout").submit(function (e) {
            ...
            var $ajaxLoader = $("#formAjout .loader-overlay");
             ...
             if (ajout==true) {
                var methode = 'POST';
                var url = "{{route('taxe.localites.store')}}";
             }else{
